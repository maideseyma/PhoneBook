...
namespace PhoneBookUI.Areas.Admin.Components
{
    public class AdminLeftMenu:ViewComponent
    {
        ...
        private readonly IMemberManager _memberPhoneManager;

        public AdminLeftMenu(IMemberManager memberManager, IphoneTypeManager phoneTypeManager, IMemberManager memberPhoneManager)
        {
